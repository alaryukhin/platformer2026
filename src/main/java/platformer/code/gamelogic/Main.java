...
public class Main extends GameBase implements PlayerDieListener, PlayerWinListener, ScreenTransitionListener{
	...
	public void init() {
		...
		try {
			levels[0] = LeveldataLoader.loadLeveldata("src/main/java/platformer/maps/NewLevel1.txt");
			levels[1] = LeveldataLoader.loadLeveldata("src/main/java/platformer/maps/NewLevel2.txt");
		} catch (Exception e) {
			e.printStackTrace();
		}
